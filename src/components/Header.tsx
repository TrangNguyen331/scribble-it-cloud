            ...
            <Marquee speed={80} gradient={false}>
              <span style={{ marginLeft: '50px', marginRight: '50px', padding: '5px' }}>
                <span style={{ marginLeft: '10px', marginRight: '50px' }}>
                  NHÓM 4 - Cloud Computing Project
                </span>
                <span style={{ marginLeft: '10px', marginRight: '50px' }}></span>
              </span>
            </Marquee>
          </div>
          <div className={sTittle}>
            <a onClick={() => navigate("/")}>Deep Cognition</a>
          </div>
          <div className={sGrid}>
            <div>
            ...
            <div>
              <a href={"https://github.com/TrangNguyen331/scribble-it-cloud"}>Github</a>
            </div>
            <div>
